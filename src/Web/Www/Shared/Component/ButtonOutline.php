...
class ButtonOutline extends Component {
    public string $classes = 'inline-flex rounded border transition-all hover:scale-105 duration-50 items-center shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2';
    ...
    public function __construct(
        ...
        $this->classes .= match ($this->color) {
            'gray' => ' text-gray-600 border-gray-300 hover:text-gray-700 hover:bg-gray-50 shadow-gray-500/20 hover:shadow-gray-500/20 focus:ring-gray-300',
